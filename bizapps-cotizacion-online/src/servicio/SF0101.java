...
public class SF0101 {
	...
	public List<F0101> buscarPorNombre(String nombre) {
		return f0101DAO.findByAbalph(nombre);
	}

	public List<F0101> buscarPorAt1(String string) {
		return f0101DAO.findByAbat1AllIgnoreCase(string);
	}
}
